...
- The [September feature review](references/microsoft-foundry.md#september-2026-feature-review) covers durable execution, steering/HITL, memory, discovery and skills, routines, Foundry IQ, evaluation/Replay, optimization/ROI, multi-model routing, residency/networking, channels, developer tooling, and lifecycle changes. Catalog entries are not treated as GA evidence; unverified product and release claims remain flagged.
